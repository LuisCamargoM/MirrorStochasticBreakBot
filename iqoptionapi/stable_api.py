...
class IQ_Option:
    ...
    def get_all_open_time_v2(self):
        # For turbo and binary options
        OPEN_TIME   = dict()
        ...
        for option in ['turbo', 'binary']:
            ...
            for actives_id in binary_data[option]["actives"]:
                ...
                if active["enabled"] == True:
                    if not active["is_suspended"]:
                        open_actives.append(name)
            OPEN_TIME[option] = open_actives
        ...
        for digital in digital_data:
            ...
            for schedule_time in schedule:
                ...
                if start < time.time() < end:
                    open_actives.append(name)
        OPEN_TIME['digital'] = open_actives
        return OPEN_TIME
